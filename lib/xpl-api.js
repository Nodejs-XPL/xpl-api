...
var APIv1 = function(configuration) {
  ...
  if (!this._configuration.localAddress) {
    ...
    var family = (this._configuration.socketType == "udp6")
        ? "IPv6" : "IPv4";
    ...
    if (!this._configuration.localAddress) {
      this._configuration.localAddress = (this._configuration.socketType == "udp6")
          ? "::1" : "127.0.0.1";
    }
  }
...
APIv1.prototype._getSocket = function(sem, cacheName, address, port,
  ...
  this._log("_getSocket: '" + cacheName + "' get socket for address=", address,
  ...
  sem.take(function() {
    ...
    self._connect(address, port, broadcastType,
        function(error, socket, address) {
          self._log("_getSocket: '" + cacheName + "' Connection result error=",
